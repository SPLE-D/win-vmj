...
public class CheckInResourceImpl extends CheckInResourceDecorator {
    ...
    @Restricted(permission = "saveTimeStampCheckIn")
    ...
    @Restricted(permission = "updateTimeStampCheckIn")
    ...
    @Restricted(permission = "detailTimeStampCheckIn")
    ...
    @Restricted(permission = "deleteTimeStampCheckIn")
