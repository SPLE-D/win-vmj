...
public class ReportResourceImpl extends ReportResourceDecorator {
    ...
    @Restricted(permission = "savePriorityReport")
    ...
    @Restricted(permission = "updatePriorityReport")
    ...
    @Restricted(permission = "detailPriorityReport")
    ...
    @Restricted(permission = "deletePriorityReport")
